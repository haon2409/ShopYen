 		...
 		function widget($args,$instance)
 		{
			...
			if($Rich_Web_Slider_Effect[0]->rich_fsl_Desc_Show==''){	$rich_fsl_Desc_Show = 'false'; }else{ $rich_fsl_Desc_Show = 'true';	}
 		 	...
 		 	<?php if($Rich_Web_Slider_Effects[0]->slider_type=='Slider Navigation'){ ?>
				...
				<style type="text/css">
					...
					.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav a, .flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .arrow { height:100% !important;}
					.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav a
					{
 		 	...
 		 	<?php } else if($Rich_Web_Slider_Effects[0]->slider_type=='Content Slider'){ ?>
				...
				?>
	 		 	<style>
					...
					.is-container .is-background img { width: 100%;	height: 100%; left: 0; position: absolute; }
				...
				<script type="text/javascript">
					!function($){
						...
						$.fn.immersive_slider<?php echo $Rich_Web_Slider_Manager[0]->id;?> = function(options){
						    ...
						    $(".main_<?php echo $Rich_Web_Slider_Manager[0]->id;?>").hover(function(){ y=true; }, function(){ y=false; });						    
		    ...
		    <?php }else if($Rich_Web_Slider_Effects[0]->slider_type=='Slider Carousel'){ ?>
				...
				<style type="text/css">
					...
					.Rich_Web_PSlider_SC_Popup_Photo_<?php echo $Rich_Web_Slider_Manager[0]->id;?> { width: 100%; height: 100% !important; margin: 0; padding: 0; cursor: pointer; }
				...
				<script>
					jQuery(document).ready(function(){					
						...
						function resp<?php echo $Rich_Web_Slider_Manager[0]->id;?>(){
							...
							jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .figure_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').css('width',Math.floor(Rich_Web_AccordSl_ImgW_<?php echo $Rich_Web_Slider_Manager[0]->id;?>*jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').width()/1000));
							jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .figure_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').css('left',Math.floor((jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').width()-jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .figure_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').width())/(array_<?php echo $Rich_Web_Slider_Manager[0]->id;?>.length-1)));
							jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .input_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').css('width',Math.floor((jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').width()-jQuery('.ia-container_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .figure_<?php echo $Rich_Web_Slider_Manager[0]->id;?>').width())/(array_<?php echo $Rich_Web_Slider_Manager[0]->id;?>.length-1)));
				...
				<style>
					...
					<?php if($Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_N_BS=="Type 1"){ ?>
						.cd-slider-wrapper<?php echo $Rich_Web_Slider;?>
						{
							...
							-moz-box-shadow:0px 0px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_ShC;?> !important;
							-webkit-box-shadow:0px 0px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_ShC;?> !important;
						}
					<?php }else{?>
						.cd-slider-wrapper<?php echo $Rich_Web_Slider;?>
						{
							...
							-moz-box-shadow:0px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_ShC;?> !important;
							-webkit-box-shadow:0px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_BSh;?>px <?php echo $Rich_Web_Slider_Effect[0]->Rich_Web_AnSL_ShC;?> !important;
						}
					<?php } ?>
					...
					.comment_content .cd-slider li:before, .entry-content .cd-slider li:before { display:none !important; }
